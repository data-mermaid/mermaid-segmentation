...
def _fill_regional_quota(
    ...
    dominant = (
        df_annotations.groupby("image_id", sort=False)
    ...
    for _region, region_df in image_sets.groupby("region_name", sort=False):
        ...
        chosen: list[str] = []
        by_class = pool.groupby("dominant_benthic_attribute_name", sort=False)
        class_ids = {
