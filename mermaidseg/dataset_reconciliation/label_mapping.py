...
def fetch_catlin_seaview_to_mermaid(
    ...
    """
    return {'aarcheri': ['aplysina archeri'], 'acervicornis': ['acropora cervicornis'], 'acompresa': ['amphimedon compressa'], 'acropora corymbose/tabular/plate': ['Acropora'], 'acropora digitate': ['Acropora'], 'acroporidae other': ['acroporidae'], 'acroporidae branching': ['acroporidae'], 'acroporidae hispidose': ['acroporidae'], 'acroporidae plate/encrusting': ['acroporidae'], 'acroporidae table/corymbose/digitate': ['acroporidae'], 'afistularis': ['aplysina fistularis'], 'agaricia/undaria': ['agaricia'], 'aiolochroia crassa': ['aiolochroia crassa'], 'alcyoniidae': ['alcyoniidae'], 'algae matrix': ['epilithic algal matrix'], 'algae: large visible globules': ['Turf algae'], 'apalmata': ['acropora palmata'], 'aplysina fulva_cauliformis': ['aplysina'], 'atubulata': ['agelas tubulata'], 'bra: acropora bottlebrush': ['Acropora'], 'bra: acropora branching': ['Acropora'], 'bra: other': ['other'], 'branching porites': ['porites'], 'branching stylophora': ['stylophora'], 'cca': ['crustose coralline algae'], 'calcifying algae: halimeda': ['halimeda'], 'calcifying algae: padina': ['padina'], 'calcifying macroalgae: padina': ['padina'], 'cdelitrix': ['cliona delitrix'], 'cnatans': ['colpophyllia natans'], 'common lrg alcyoniide': ['alcyoniidae'], 'coral: meandroid': ['Hard coral'], 'cplicifera': ['callyspongia plicifera'], 'crinoids': ['crinoid'], 'crustose coralline algae': ['crustose coralline algae'], 'cvaginalis': ['callyspongia vaginalis'], 'cyanobacteria': ['cyanobacteria'], 'cyanobacteria films': ['cyanobacteria'], 'cyanobacteria on rock or other substrates': ['cyanobacteria'], 'cyanobacteria smothering dead coral': ['cyanobacteria'], 'cyanobacteria smothering rubble': ['cyanobacteria'], 'diadema/ehinothix': ['Sea urchin'], 'dictyota': ['dictyota'], 'dlabyrinthiformis': ['diploria labyrinthiformis'], 'echinometra': ['echinometra'], 'encrusting cliona spp.': ['cliona'], 'encrusting gorgonian': ['gorgonia'], 'encrusting sponge': ['Sponge'], 'epilithic algal matrix': ['epilithic algal matrix'], 'epilithic algal matirx smotheting rubble': ['epilithic algal matrix'], 'epilithic algal matrix on rock or other substrates': ['epilithic algal matrix'], 'epillithic algal matrix': ['epilithic algal matrix'], 'erect rhodphyta': ['rhodophyta'], 'erect gorgonians': ['gorgonia'], 'erect sponge': ['Sponge'], 'eusmilia fastigiata': ['eusmilia fastigiata'], 'favidae-mussidae massive/meandroid': ['Hard coral'], 'filamentous macroalgae': ['macroalgae'], 'fish': ['Unknown'], 'foliose algae: other': ['Turf algae'], 'foliose fan shaped algae': ['Turf algae'], 'foliose feathery algae': ['Turf algae'], 'foliose strap/ branched algae': ['Turf algae'], 'foliose sheeting macroalage: (e.g ulva)': ['macroalgae'], 'halimeda': ['halimeda'], 'hydroids feathery types': ['hydroid'], 'individual tunicates': ['tunicate'], 'ircinia_massive': ['ircinia'], 'leathery macrophyte: other': ['macroalgae'], 'leptoseris': ['leptoseris'], 'loose substrate: rubble': ['Rubble'], 'loose substrate: sand': ['Sand'], 'lvariegata': ['lobophora variegata'], 'mase: isopora': ['isopora'], 'mase: lobophyllia': ['lobophyllia'], 'mase: meandering other': ['Hard coral'], 'mase: porites': ['porites'], 'macroalgae': ['macroalgae'], 'macroalgae 1': ['macroalgae'], 'macroalgae encrusting red': ['macroalgae'], 'macrolagae all genera': ['macroalgae'], 'madracis': ['madracis'], 'massive sponge': ['Sponge'], 'massive or encrusting sponges': ['Sponge'], 'mat tunicate': ['tunicate'], 'meandrina': ['meandrina'], 'millepora': ['Milleporidae'], 'montastrea cavernosa': ['montastraea cavernosa'], 'montipora capitata branching': ['montipora capitata'], 'montipora capitata plate': ['montipora capitata'], 'montipora flabellata': ['montipora flabellata'], 'montipora patula': ['montipora patula'], 'mycale laevis': ['mycale laevis'], 'niphates digitalis': ['niphates digitalis'], 'non hermatypic: millepora': ['Milleporidae'], 'non hermatypic: heliopora': ['heliopora'], 'ocomplex': ['orbicella'], 'other': ['other'], 'other acroporidae': ['acroporidae'], 'other algae': ['Turf algae'], 'other sesile invertebrates bryozoa clams': ['invertebrate'], 'other sesile invertebrates soft hexacorrallia': ['Hard coral'], 'other sessile invertebrates': ['invertebrate'], 'pastreoides': ['porites astreoides'], 'pavona duerdeni': ['pavona duerdeni'], 'pavona maldivensis': ['pavona maldivensis'], 'pavona varians': ['pavona varians'], 'pocillopora damicornis': ['pocillopora damicornis'], 'pocillopora eydouxi': ['pocillopora grandis'], 'pocillopora meandrina/ligulata': ['Pocillopora'], 'pocillopora species': ['Pocillopora'], 'pocilloporidae': ['pocilloporidae'], 'porites compressa fused branches': ['porites compressa'], 'porites lichen': ['porites lichen'], 'porites lobata/lutea': ['porites'], 'porites nodular branches': ['porites'], 'porites rus/monticulosa': ['porites'], 'poritidae branching': ['poritidae'], 'poritidae encrusting': ['poritidae'], 'poritidae massive': ['poritidae'], 'porties compressa fingres': ['porites compressa'], 'pporites': ['porites porites'], 'pseudodiploria': ['pseudodiploria'], 'rope sponge': ['Sponge'], 'sand': ['Sand'], 'sea cucumbers/sea urchins/sea stars/lobster': ['invertebrate'], 'sea fans and plumes': ['gorgoniidae'], 'sea fans/plumes': ['gorgoniidae'], 'sea fans/plumes/branching whipes': ['gorgoniidae'], 'seagrass': ['Seagrass'], 'siderastrea siderea': ['siderastrea siderea'], 'sponge': ['Sponge'], 'sponges': ['Sponge'], 'sponges: branching/rope forms': ['Sponge'], 'sponges: fan shaped forms': ['Sponge'], 'sponges: hollow sponge forms/cups/barrels/tubes/et al': ['Sponge'], 'tfp: porites': ['porites'], 'terrigenous sediment with turf': ['turf algae'], 'transect hardware': ['Unknown'], 'trash: human origin': ['Trash'], 'turf': ['turf algae'], 'turf algae': ['turf algae'], 'turf algae and sand': ['turf algae'], 'turf sand': ['turf algae'], 'unknown': ['unknown'], 'utenuifolia': ['agaricia tenuifolia'], 'vase sponge': ['Sponge'], 'water': ['Unknown', 'Obscured'], 'xmuta': ['xestospongia muta'], 'zoanthid': ['zoanthid']}
    response = requests.get(mapping_endpoint, timeout=30)
    response.raise_for_status()
    data = response.json()
    labelset = list(data["results"])
...
def fetch_moorea_labeled_corals_to_mermaid(
    ...
    """
    return {'acan': ['acanthastrea'], 'acrop': ['Acropora'], 'astreo': ['astreopora'], 'cca': ['crustose coralline algae'], 'cypha': ['cyphastrea'], 'favia': ['favia'], 'gardin': ['gardineroseris'], 'herpo': ['herpolitha'], 'lepta': ['leptastrea'], 'lepto': ['leptoseris'], 'lobo': ['lobophyllia'], 'macro': ['macroalgae'], 'mille': ['Milleporidae'], 'monta': ['montastraea'], 'monti': ['montipora'], 'off': ['other'], 'p mass': ['porites'], 'p. irr': ['porites rus'], 'p. rus': ['porites rus'], 'pocill': ['Pocillopora'], 'porit': ['porites'], 'psam': ['psammocora'], 'sand': ['Sand'], 'stylo': ['stylophora'], 'tuba': ['tubastraea'], 'turf': ['turf algae']}
    response = requests.get(mapping_endpoint, timeout=30)
    response.raise_for_status()
    data = response.json()
    labelset = list(data["results"])
...
def fetch_pacific_labeled_corals_to_mermaid(
    ...
    """
    return {'acropora': ['Acropora'], 'all other': ['other'], 'cca': ['crustose coralline algae'], 'favia': ['favia'], 'favites': ['favites'], 'macroalgae': ['macroalgae'], 'millepora': ['Milleporidae'], 'montipora': ['montipora'], 'platygyra': ['platygyra'], 'pocillopora': ['Pocillopora'], 'porites': ['porites'], 'sand': ['Sand'], 'sponges': ['Sponge'], 'transect hardware': ['Unknown'], 'turf': ['turf algae'], 'unclear': ['Unknown', 'Obscured']}
    response = requests.get(mapping_endpoint, timeout=30)
    response.raise_for_status()
    data = response.json()
    labelset = list(data["results"])
