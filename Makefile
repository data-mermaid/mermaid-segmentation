...
# --- Issue #129: LinearDINOv3 baseline (Mermaid + CoralNet, no CBM) ---
# Run the baseline experiment described in issue #129.
# Data: Mermaid (train) + CoralNet (train+val) — no CBM.
# Model: LinearDINOv3 with facebook/dinov3-vitb16.
